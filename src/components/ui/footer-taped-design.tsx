...
const contactLinks = [
  ...
  {
    label: "Behance",
    value: "Portfólio Agni",
    href: "https://www.behance.net/agnigarcia",
    external: true,
  },
  {
    label: "E-mail",
    value: "contato@suaarquiteta.com.br",
...
export function FooterTapedDesign() {
  ...
  return (
    <footer className="bg-cream-dark/40 px-5 py-12 md:px-10 lg:px-16">
      <div className="mx-auto max-w-5xl">
        <div className="relative mx-auto flex flex-col items-center justify-between gap-6 rounded-3xl border border-ink/8 bg-white/80 px-4 py-10 shadow-[0_20px_50px_-28px_rgba(26,24,20,0.25)] backdrop-blur-sm md:flex-row">
          <div className="absolute -top-4 -left-8 hidden h-9 w-20 scale-75 text-brand/80 md:block">
            {tape}
          </div>
          <div className="absolute -top-4 -right-8 hidden h-9 w-20 rotate-90 scale-75 text-brand/80 md:block">
            {tape}
          </div>

          <div className="flex flex-1 flex-col items-start justify-between gap-8 px-2 md:flex-row md:gap-10 md:px-8">
            <div className="flex flex-col items-start gap-3">
              <Link href="#section_one" className="inline-flex">
                <Image
                  src="/assets/images/logo_agni_garcia_arquitetura_white.png"
              ...
              <h4 className="heading-display text-2xl font-medium text-ink">
                Ainda com dúvidas?
              </h4>
              ...
              <ShinyButton
                ...
                className="mt-2 rounded-full border-0 bg-brand px-6 py-3 hover:bg-brand-light"
                spanClassName="text-cream"
              >
                WhatsApp
              </ShinyButton>
            </div>
              ...
              <div className="flex flex-col gap-3">
                ...
                <div className="flex flex-col gap-3 text-sm">
                  {contactLinks.map((item) => (
                    <p key={item.label} className="text-ink/85">
